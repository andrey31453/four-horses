...
grid-template-columns: repeat(${3*n(this,o,E).length}, 1fr);`},m1=new WeakMap,S=new WeakMap,W=new WeakMap,g1=new WeakMap,f1=new WeakMap;customElements.define("a-slider",_2);var d,j,L1,b1,h,A,v1,x1,y1,z,O1,H1,d2,l2,w1,D1,V1,$1,B1,X;class q2 extends HTMLElement{constructor(){super();a(this,h);a(this,d);a(this,j);a(this,L1,async()=>{n(this,b1).call(this),w(this,j,await N1.call(this,n(this,w1),n(this,X),()=>!0)),n(this,v1).call(this)});a(this,b1,()=>{w(this,d,n2(this.getAttribute(V.id)))});a(this,v1,()=>{$.emit(`${this.getAttribute(V.id)}-prev`,n(this,D1)),$.emit(`${this.getAttribute(V.id)}-next`,n(this,V1)),n(this,d).emit("update",n(this,X))});a(this,x1,()=>`
<div class="relative">
...
<div class="flex justify-center items-center gap-1.5 text-golos transition">
	${[...Array(n(this,d).state.slide.quantity).keys()].map(n(this,x1)).join("")}
</div>`);a(this,z,t=>t<0?n(this,z).call(this,t+n(this,d).state.slide.quantity):t>n(this,d).state.slide.quantity-1?n(this,z).call(this,t-n(this,d).state.slide.quantity):t+1);a(this,H1,()=>`
<div class="flex justify-center items-center gap-1 text-golos">
	...
	<span id='decimal-quantity' class="text-secondary-500">${n(this,d).state.slide.quantity}</span>
</div>`);a(this,w1,()=>{y.call(this,`
<div class="min-h-9 flex justify-center md:justify-end items-center gap-4">
	${n(this,h,l2)}
</div>

${x()}`)});a(this,D1,()=>{n(this,d).prev(),n(this,d).on("update")});a(this,V1,()=>{n(this,d).next(),n(this,d).on("update")});a(this,$1,()=>{n(this,d).props["controls-variant"]==="decimal"&&(n(this,h,A)["decimal-current"].innerHTML=n(this,h,O1),n(this,h,A)["decimal-quantity"].innerHTML=n(this,d).state.slide.quantity)});a(this,B1,()=>{n(this,h,A).dots.forEach((t,i)=>{i===n(this,d).state.slide.current?t.classList.remove("hidden"):t.classList.add("hidden")})});a(this,X,()=>{n(this,h,A).prev.setAttribute("a-disabled",n(this,d).state.disabled.prev),n(this,h,A).next.setAttribute("a-disabled",n(this,d).state.disabled.next),n(this,$1).call(this),n(this,B1).call(this)});n(this,L1).call(this)}disconnectedCallback(){s2(n(this,j))&&n(this,j).call(this),$.off(`${this.getAttribute(V.id)}-prev`),$.off(`${this.getAttribute(V.id)}-next`)}}d=new WeakMap,j=new WeakMap,L1=new WeakMap,b1=new WeakMap,h=new WeakSet,A=function(){return{prev:this.shadowRoot.getElementById("prev"),next:this.shadowRoot.getElementById("next"),"decimal-current":this.shadowRoot.getElementById("decimal-current"),"decimal-quantity":this.shadowRoot.getElementById("decimal-quantity"),dots:this.shadowRoot.querySelectorAll(".js__dot"),"dot-animates":this.shadowRoot.querySelectorAll(".js__dot-animate")}},v1=new WeakMap,x1=new WeakMap,y1=new WeakMap,z=new WeakMap,O1=function(){return n(this,z).call(this,n(this,d).state.slide.current+n(this,d).cols-1)},H1=new WeakMap,d2=function(){return{dots:n(this,y1),decimal:n(this,H1)}[n(this,d).props["controls-variant"]]()??""},l2=function(){return`
...
>
	<a-container class="grid grid-cols-12 gap-6">
		<div
			class="about__image col-span-12 md:col-span-5"
...
`,at=s=>{var e;(e=document.querySelector(s))==null||e.scrollIntoView({behavior:"smooth",block:"start"})},rt=()=>{$.emit("scroll-to",at)},ot={spin:"animate-spin",bounce:"animate-bounce",pulse:"animate-pulse",ping:"animate-ping","from-left":"animate-from-left","from-right":"animate-from-right","from-bottom":"animate-from-bottom","from-top":"animate-from-top"},dt=()=>{document.querySelectorAll("[a-animation]").forEach(s=>{s.classList.add("invisible");const e={name:A2(s,"a-animation","pulse"),infinity:e2(s,"a-animation-infinity")};new IntersectionObserver((t,i)=>{t[0].isIntersecting&&(s.classList.remove("invisible"),s.classList.add(ot[e.name]),i.unobserve(s))},{threshold:.25}).observe(s)})};F2().use(U2).use(rt).use(dt).template(G1("div",null,x())).template(G1("div",{id:"main",class:"bg-white text-black text-merriweather"},[Y2,K1,Z("h-14 md:h-24"),tt,Z("h-6 md:h-16"),et,Z("h-30 md:h-50"),nt,Z("h-30 md:h-50"),it,Z("h-25 md:h-35"),K1,st])).mount("#app");
