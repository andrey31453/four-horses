var v2=Object.defineProperty;var Q1=s=>{throw TypeError(s)};var x2=(s,e,t)=>e in s?v2(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var c=(s,e,t)=>x2(s,typeof e!="symbol"?e+"":e,t),T1=(s,e,t)=>e.has(s)||Q1("Cannot "+t);var n=(s,e,t)=>(T1(s,e,"read from private field"),t?t.call(s):e.get(s)),a=(s,e,t)=>e.has(s)?Q1("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(s):e.set(s,t),w=(s,e,t,i)=>(T1(s,e,"write to private field"),i?i.call(s,t):e.set(s,t),t),g=(s,e,t)=>(T1(s,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const d of r)if(d.type==="childList")for(const H of d.addedNodes)H.tagName==="LINK"&&H.rel==="modulepreload"&&i(H)}).observe(document,{childList:!0,subtree:!0});function t(r){const d={};return r.integrity&&(d.integrity=r.integrity),r.referrerPolicy&&(d.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?d.credentials="include":r.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(r){if(r.ep)return;r.ep=!0;const d=t(r);fetch(r.href,d)}})();const U1=100,I1=(s,e=U1)=>{let t=null;return(...i)=>{window.clearTimeout(t),t=window.setTimeout(()=>s(...i),e)}},y2=(s,e=U1)=>{let t=null;return(...i)=>{t||(t=setTimeout(()=>{s(...i),clearTimeout(t),t=null},e))}};let K=[];const $={emit:(s,e)=>{K.push({name:s,cb:e})},on:({target:s,name:e,props:t,type:i})=>{s.addEventListener(i??"click",y2(()=>{K.filter(r=>r.name===e).forEach(({cb:r})=>r(t??null))}))},off:s=>{K=K.filter(e=>e.name!==s)}},H2="text-golos font-medium transition flex justify-center items-center cursor-pointer",W1={"a-severity":{contrast:["text-white hover:text-black disabled:text-white","bg-black hover:bg-yellow disabled:bg-secondary-800","border-black hover:border-yellow disabled:border-secondary-800"],secondary:["text-black hover:text-white disabled:text-secondary-800","bg-white/50 md:bg-transparent hover:bg-black disabled:bg-transparent","md:border-black hover:border-black disabled:border-secondary-800"],info:["text-blue hover:text-white disabled:text-secondary-800","bg-transparent hover:bg-blue disabled:bg-transparent","border-blue hover:border-blue disabled:border-secondary-800"]},"a-size":{sm:"h-9 rounded-4.5 border-1 leading-120",lg:"h-18 rounded-9 border-2 leading-130 p-5"},"a-icon":{false:"",true:"size-9 rounded-full"},"a-disabled":{false:"",true:"pointer-events-none"}};var t1,I,e1,N,n1;class Y1 extends HTMLButtonElement{constructor(){super();a(this,t1);a(this,I);a(this,e1,()=>{$.on({target:this,type:this.getAttribute("a-type"),name:this.getAttribute("a-name"),props:this.getAttribute("a-props")})});a(this,N,()=>{let t=[];Object.entries(W1).forEach(([i,r])=>{const d=this.getAttribute(i)===""||this.getAttribute(i),[H,p]=Object.entries(r).find(([b])=>b===String(d))||Object.entries(r)[0];p&&[p].flat(1/0).join(" ").split(" ").forEach(b=>t.push(b))}),this.className=[H2,n(this,I),t.join(" ")].join(" ")});a(this,n1,(t,i)=>{t==="a-disabled"&&(i==="true"?this.setAttribute("disabled",""):this.removeAttribute("disabled"))});w(this,t1,Math.random()),w(this,I,this.className),n(this,e1).call(this),n(this,N).call(this)}attributeChangedCallback(t,i,r){n(this,n1).call(this,t,r),n(this,N).call(this)}disconnectedCallback(){$.off(this.getAttribute("a-name"))}}t1=new WeakMap,I=new WeakMap,e1=new WeakMap,N=new WeakMap,n1=new WeakMap,c(Y1,"observedAttributes",Object.keys(W1));customElements.define("a-button",Y1,{extends:"button"});class w2 extends HTMLElement{constructor(){super(),this.classList.add("md:px-18"),this.classList.add("sm:px-8"),this.classList.add("px-5"),this.classList.add("block")}}customElements.define("a-container",w2);class D2 extends HTMLAnchorElement{constructor(){super(),this.classList.add("text-blue"),this.classList.add("decoration-none"),this.classList.add("leading-120"),this.classList.add("text-golos")}}customElements.define("a-link",D2,{extends:"a"});var s1,i1,a1,t2;class V2 extends HTMLElement{constructor(){super();a(this,a1);a(this,s1,()=>{$.emit("participant-goTo",n(this,i1))});a(this,i1,t=>{window.open(t,"_blank")});g(this,a1,t2).call(this),n(this,s1).call(this)}}s1=new WeakMap,i1=new WeakMap,a1=new WeakSet,t2=function(){this.innerHTML=`
...
</div>`};customElements.define("a-participant",V2);const x=()=>'<link href="styles/a-tailwind.css" rel="stylesheet">',y=function(s){!this.shadowRoot&&this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=s};var B,q1,S1;class $2 extends HTMLElement{constructor(){super();a(this,B);g(this,B,S1).call(this),window.addEventListener("resize",I1(g(this,B,S1).bind(this)))}}B=new WeakSet,q1=function(t=!1){return`<div ${t?'aria-hidden="true"':""} class="marquee-items flex justify-start items-center gap-3">`+[...this.children].reduce((i,r)=>`
${i}
...
</style>`)};customElements.define("a-running-line",$2);const X1=(s=100)=>new Promise((e,t)=>{setTimeout(()=>void e(),s)}),N1=async function(s=[],e=[],t=null){const i=e?[e].flat().map(p=>I1(p.bind(this))):[],r=()=>{i.forEach(p=>{window.removeEventListener("resize",p)})},d={quantity:0,max:10},H=async function(){return d.quantity++,d.quantity>d.max?console.error("Превышено время ожидания компонента: ",this):(t?!t.call(this):!this.querySelector("*"))?(await X1(),await H.call(this)):(s&&[s].flat().forEach(p=>{p.call(this)}),i.forEach(p=>{p.call(this),window.addEventListener("resize",p)}),r)};return await X1(),await H.call(this)},B2=s=>Object.entries(s).reduce((e,[t,i])=>(e[t]=i/16+"rem",e),{}),E2=s=>{if(!s.startsWith("#"))return s;const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return e?`${parseInt(e[1],16)}, ${parseInt(e[2],16)}, ${parseInt(e[3],16)}`:console.error(`don't correct hex color: ${s}`)},M2=s=>Object.entries(s).reduce((e,[t,i])=>(e[t]=E2(i),e),{}),Y={screens:{xs:0,sm:640,md:768,lg:1024,xl:1280},sizes:{quantity:140},grid:{cols:12},font:{bold:{thin:100,extralight:200,light:300,normal:400,medium:500,semibold:600,bold:700,extrabold:800,black:900},sizes:B2({xs:16,sm:18,base:20,lg:22,xl:24,"2xl":28,"3xl":36,"4xl":54,"5xl":60}),leadings:{min:50,max:150,step:5}},colors:M2({transparent:"transparent",white:"#ffffff",black:"#313131",red:"#f54932",yellow:"#fbce51",blue:"#3057a2",primary:"#f54932",surface:"#e9ded4","secondary-200":"#585653","secondary-300":"#6f6f6f","secondary-400":"#7b7672","secondary-500":"#838383","secondary-600":"#8b8b8b","secondary-700":"#d0d0d0","secondary-800":"#d5d5d5","secondary-900":"#e9ded4"}),animations:{vars:{"animation-duration":{value:100,measurement:"ms"}},durations:{max:4e3,step:100}},content:["./index.html","./src/main.js","./src/components","./src/templates","./src/composables"],safeList:[...Array(12).keys()].map(s=>[`md:grid-cols-${s+1}`,`grid-cols-${s+1}`,`col-span-${s+1}`,`row-span-${s+1}`]).flat()},j1=(s,e=0)=>{[s].flat().forEach((t,i)=>setTimeout(t,10*i+e))},V={id:"a-id"},O=(s,e,t={})=>{if(!s)return console.error("don't correct target: ",s);const i=s.getAttribute(e);return!i||i===""?t:JSON.parse(s.getAttribute(e)??null)||t},F1=new Map().set("",!0).set("true",!0).set("false",!1).set(null,!1),e2=(s,e)=>{if(!s)return console.error("don't correct target: ",s);const t=s.getAttribute(e);return F1.has(t)?F1.get(t):console.error("don't correct props: ",e)},A2=(s,e,t)=>s?s.getAttribute(e)??t:console.error("don't correct target: ",s),u={props:{},state:{},cbs:{}};var r1,o1;class k2{constructor(){c(this,"props",e=>u.props[e]);c(this,"state",e=>u.state[e]);c(this,"cbs",e=>u.cbs[e]);c(this,"off",e=>{u.cbs[e]=[]});a(this,r1,e=>{u.props[e]=null,u.state[e]=null,u.cbs[e]=[]});a(this,o1,(e,t)=>{u.props[e]={"controls-variant":t.getAttribute("controls-variant")??"dots",infinity:e2(t,"infinity"),"auto-change":+t.getAttribute("auto-change"),slides:O(t,"slides",{xs:1,sm:2,md:3,xl:4})}});c(this,"defineState",(e,t)=>{if(u.props[e].infinity){u.state[e]={slide:{current:0,quantity:t.children.length,min:-1,max:t.children.length},ctx:t};return}u.state[e]={slide:{current:0,quantity:t.children.length,min:0,max:t.children.length-1},ctx:t}})}define(e,t){n(this,r1).call(this,e),n(this,o1).call(this,e,t),this.defineState(e,t)}update(e){u.state[e].disabled={prev:!u.props[e].infinity&&u.state[e].slide.current===u.state[e].slide.min,next:!u.props[e].infinity&&u.state[e].slide.current===u.state[e].slide.max}}}r1=new WeakMap,o1=new WeakMap;const f=new k2,P1=s=>Y.screens[s]===void 0?console.error(`don't correct screen key: ${s}`):document.documentElement.clientWidth>=Y.screens[s],R=s=>Object.entries(s).reduce((e,[t,i])=>P1(t)?i:e,1);var m,l1,k,P,Q,T,d1;class T2{constructor(e,t){a(this,m);a(this,l1);c(this,"updateQuantity",e=>{f.state(n(this,m)).slide.quantity=e,n(this,k).call(this)});a(this,k,()=>{this.state.slide.current<0&&j1(()=>{this.state.slide.current=this.state.slide.quantity+this.state.slide.current,this.on("force-update")}),this.state.slide.current>this.state.slide.quantity-1&&j1(()=>{this.state.slide.current=this.state.slide.current-this.state.slide.quantity,this.on("force-update")})});c(this,"emit",(e,t)=>{f.cbs(n(this,m)).push({name:e,cb:t})});c(this,"on",e=>{f.cbs(n(this,m)).filter(({name:t})=>t===e).forEach(({cb:t})=>t())});c(this,"off",()=>{f.off(n(this,m))});c(this,"prev",()=>{n(this,Q).call(this),this.state.slide.current--,f.update(n(this,m)),n(this,k).call(this)});c(this,"next",()=>{n(this,Q).call(this),n(this,P).call(this)});a(this,P,()=>{this.state.slide.current++,f.update(n(this,m)),n(this,k).call(this)});a(this,Q,()=>{this.props["auto-change"]&&(clearTimeout(this.state.timeout),n(this,T).call(this))});a(this,T,()=>{this.state.timeout=setTimeout(()=>{n(this,P).call(this),this.on("update"),n(this,T).call(this)},1e3*this.props["auto-change"])});a(this,d1,()=>{if(this.props["auto-change"]){if(!this.props.infinity)return console.error("Auto-сhange можно применять только вместе с infinity");n(this,T).call(this)}});w(this,m,e),t&&(w(this,l1,t),f.define(e,t),f.update(e),n(this,d1).call(this,e))}get state(){return f.state(n(this,m))}get props(){return f.props(n(this,m))}get cbs(){return f.cbs(n(this,m))}get cols(){return R(this.props.slides)}}m=new WeakMap,l1=new WeakMap,k=new WeakMap,P=new WeakMap,Q=new WeakMap,T=new WeakMap,d1=new WeakMap;const _1={},n2=(s,e)=>(_1[s]||(_1[s]=new T2(s,e)),_1[s]),s2=s=>typeof s=="function";var L,_,c1,C1,u1,o,E,M,h1,q,i2,p1,a2,z1,U,Z1,r2,o2,m1,S,W,g1,f1;class _2 extends HTMLElement{constructor(){super();a(this,o);a(this,L);a(this,_);a(this,c1,async()=>{n(this,C1).call(this),w(this,_,await N1.call(this,n(this,p1),[n(this,m1),n(this,S)])),n(this,u1).call(this),n(this,W).call(this)});a(this,C1,()=>{w(this,L,n2(this.getAttribute(V.id),this))});a(this,u1,()=>{n(this,L).emit("update",n(this,S)),n(this,L).emit("force-update",n(this,f1))});a(this,h1,(t,i)=>`
<div
	class="child flex flex-col items-center h-full" 
	style="${n(this,o,z1)}"
>
	${t.innerHTML}
</div>`);a(this,q,(t=0)=>n(this,o,E).reduce((i,r,d)=>`
${i}
${n(this,h1).call(this,r,d+t)}`,""));a(this,p1,()=>{y.call(this,`
...
${x()}`)});a(this,m1,()=>{n(this,L).updateQuantity(n(this,o,M).slider.children.length/3)});a(this,S,()=>{n(this,o,M).slider.setAttribute("style",n(this,o,o2)),n(this,o,M).children.forEach(t=>t.setAttribute("style",n(this,o,z1)))});a(this,W,()=>{n(this,o,M).slider.classList.add("transition")});a(this,g1,()=>{n(this,o,M).slider.classList.remove("transition")});a(this,f1,()=>{j1([n(this,g1),n(this,S),n(this,W)],Y.animations.vars["animation-duration"].value)});n(this,c1).call(this)}disconnectedCallback(){s2(n(this,_))&&n(this,_).call(this)}}L=new WeakMap,_=new WeakMap,c1=new WeakMap,C1=new WeakMap,u1=new WeakMap,o=new WeakSet,E=function(){return[...this.children]},M=function(){return{slider:this.shadowRoot.getElementById("slider"),children:this.shadowRoot.querySelectorAll(".child")}},h1=new WeakMap,q=new WeakMap,i2=function(){return n(this,q).call(this,-n(this,o,E).length)+n(this,q).call(this)+n(this,q).call(this,n(this,o,E).length)},p1=new WeakMap,a2=function(){return n(this,o,E).reduce((t,i)=>Math.max(t,i.clientHeight),0)},z1=function(){return`
min-width: ${n(this,o,U)}px;
max-width: ${n(this,o,U)}px;
min-height: ${n(this,o,a2)}px;`},U=function(){return n(this,o,Z1)/n(this,L).cols-20*(n(this,L).cols-1)/n(this,L).cols},Z1=function(){const t=document.body.querySelector("a-container"),i=getComputedStyle(t)["padding-left"].replace("px","");return t.offsetWidth-2*i},r2=function(){return-n(this,L).state.slide.current*(n(this,o,U)+20)},o2=function(){return`
max-width: ${n(this,o,Z1)}px;
transform: translate(${n(this,o,r2)}px, 0);
grid-template-columns: repeat(${3*n(this,o,E).length}, 1fr);`},m1=new WeakMap,S=new WeakMap,W=new WeakMap,g1=new WeakMap,f1=new WeakMap;customElements.define("a-slider",_2);var l,j,L1,b1,h,A,v1,x1,y1,z,O1,H1,l2,d2,w1,D1,V1,$1,B1,X;class q2 extends HTMLElement{constructor(){super();a(this,h);a(this,l);a(this,j);a(this,L1,async()=>{n(this,b1).call(this),w(this,j,await N1.call(this,n(this,w1),n(this,X),()=>!0)),n(this,v1).call(this)});a(this,b1,()=>{w(this,l,n2(this.getAttribute(V.id)))});a(this,v1,()=>{$.emit(`${this.getAttribute(V.id)}-prev`,n(this,D1)),$.emit(`${this.getAttribute(V.id)}-next`,n(this,V1)),n(this,l).emit("update",n(this,X))});a(this,x1,()=>`
<div class="relative">
...
<div class="flex justify-center items-center gap-1.5 text-golos transition">
	${[...Array(n(this,l).state.slide.quantity).keys()].map(n(this,x1)).join("")}
</div>`);a(this,z,t=>t<0?n(this,z).call(this,t+n(this,l).state.slide.quantity):t>n(this,l).state.slide.quantity-1?n(this,z).call(this,t-n(this,l).state.slide.quantity):t+1);a(this,H1,()=>`
<div class="flex justify-center items-center gap-1 text-golos">
	<span id="decimal-current" class="transition">${n(this,h,O1)}</span>
	<span class="text-secondary-500">/</span>
	<span id='decimal-quantity' class="text-secondary-500">${n(this,l).state.slide.quantity}</span>
</div>`);a(this,w1,()=>{y.call(this,`
<div class="min-h-9 flex justify-center md:justify-end items-center gap-4">
	${n(this,h,d2)}
</div>

${x()}`)});a(this,D1,()=>{n(this,l).prev(),n(this,l).on("update")});a(this,V1,()=>{n(this,l).next(),n(this,l).on("update")});a(this,$1,()=>{n(this,l).props["controls-variant"]==="decimal"&&(n(this,h,A)["decimal-current"].innerHTML=n(this,h,O1),n(this,h,A)["decimal-quantity"].innerHTML=n(this,l).state.slide.quantity)});a(this,B1,()=>{n(this,h,A).dots.forEach((t,i)=>{i===n(this,l).state.slide.current?t.classList.remove("hidden"):t.classList.add("hidden")})});a(this,X,()=>{n(this,h,A).prev.setAttribute("a-disabled",n(this,l).state.disabled.prev),n(this,h,A).next.setAttribute("a-disabled",n(this,l).state.disabled.next),n(this,$1).call(this),n(this,B1).call(this)});n(this,L1).call(this)}disconnectedCallback(){s2(n(this,j))&&n(this,j).call(this),$.off(`${this.getAttribute(V.id)}-prev`),$.off(`${this.getAttribute(V.id)}-next`)}}l=new WeakMap,j=new WeakMap,L1=new WeakMap,b1=new WeakMap,h=new WeakSet,A=function(){return{prev:this.shadowRoot.getElementById("prev"),next:this.shadowRoot.getElementById("next"),"decimal-current":this.shadowRoot.getElementById("decimal-current"),"decimal-quantity":this.shadowRoot.getElementById("decimal-quantity"),dots:this.shadowRoot.querySelectorAll(".js__dot"),"dot-animates":this.shadowRoot.querySelectorAll(".js__dot-animate")}},v1=new WeakMap,x1=new WeakMap,y1=new WeakMap,z=new WeakMap,O1=function(){return n(this,z).call(this,n(this,l).state.slide.current+n(this,l).cols-1)},H1=new WeakMap,l2=function(){return{dots:n(this,y1),decimal:n(this,H1)}[n(this,l).props["controls-variant"]]()??""},d2=function(){return`
...
${x()}`)};customElements.define("a-stage",j2);var C,D,u2,h2,R1,p2;class z2 extends HTMLElement{constructor(){super();a(this,C);c(this,"cols",t=>n(this,C,D)[t]?R(O(n(this,C,D)[t],"cols",{xs:1})):{xs:1});c(this,"rows",t=>n(this,C,D)[t]?R(O(n(this,C,D)[t],"rows",{xs:1})):{xs:1});c(this,"stageQuantities",t=>{const i=this.cols(t)===1?0:this.cols(t),r=this.rows(t)===1?0:this.rows(t);return!i&&!r?1:i+r});c(this,"groupClass",t=>`col-span-${this.cols(t)} row-span-${this.rows(t)}`);N1.call(this,null,g(this,C,p2))}}C=new WeakSet,D=function(){return[...this.children]},u2=function(){return R(O(this,"a-cols",12))},h2=function(){return R(O(this,"a-stages-group",1))},R1=function(){let t=`<div class="${this.groupClass(0)}"><a-stage-group>`,i=0;for(let r=0;r<n(this,C,D).length;r++)t+=`
<a-stage a-idx="${r+1}" class="${n(this,C,D)[r].className}">
	${n(this,C,D)[r].innerHTML}
</a-stage>`,i+=this.stageQuantities(r),i+this.stageQuantities(r+1)>n(this,C,h2)&&r!==n(this,C,D).length-1&&(t+=`</a-stage-group></div><div class="${this.groupClass(r+1)}"><a-stage-group>`,i=0);return t+="</a-stage-group></div>",t},p2=function(){y.call(this,`
<div class="max-md:hidden grid grid-cols-${n(this,C,u2)} gap-5">
	${n(this,C,R1)}
</div>
...
<div class="grid md:grid-cols-${n(this,v,b2)}">
	${n(this,v,L2)}
</div>

${x()}`)});n(this,F).call(this),window.addEventListener("resize",I1(n(this,F).bind(this)))}}v=new WeakSet,g2=function(t,i){return P1("md")?t:`<div class="flex justify-start items-center gap-3 py-4 ${i?"border-secondary-800 border-t-2 ":""}">${t}</div>`},f2=function(t,i,r){return[...t.children].reduce((d,H,p)=>{const b=["flex justify-start items-center md:border-secondary-800"];return p||b.push("md:py-4 md:pr-4 text-secondary-300"),p&&b.push("md:p-4 md:border-l-2"),r&&b.push("md:border-t-2"),r||b.push("md:!pt-0"),i-1===r&&b.push("md:!pb-0"),d+`<div class="${b.join(" ")}"><span class="grid"><span>${H.innerHTML}</span></span></div>`},"")},L2=function(){return[...this.children].reduce((t,i,r)=>`${t}${g(this,v,g2).call(this,g(this,v,f2).call(this,i,this.children.length,r),!!r)}`,"")},b2=function(){var t;return((t=[...this.children][0])==null?void 0:t.children.length)??2},F=new WeakMap;customElements.define("a-table",O2);const R2=`<svg viewBox="0 0 246 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
svg {
	...
	max-height: 100%;
		...
		`)}}customElements.define("a-icon",P2);var k1;class Q2 extends HTMLElement{constructor(){super();a(this,k1,()=>{document.querySelectorAll(`[a-teleport-id=${this.getAttribute("a-id")}]`).forEach(i=>i.innerHTML=this.innerHTML)});this.classList.add("hidden"),window.addEventListener("load",n(this,k1).bind(this))}}k1=new WeakMap;customElements.define("a-teleport",Q2);class W2 extends HTMLElement{constructor(){super(),y.call(this,"<slot></slot>")}}customElements.define("a-shadow",W2);var G,J;class X2{constructor(){a(this,G,[]);a(this,J,[]);c(this,"use",e=>(n(this,J).push(e),this));c(this,"template",e=>(n(this,G).push(e),this));c(this,"mount",e=>{const t=document.querySelector(e);if(!t)throw new Error(`Body not have ${e}`);t.setAttribute("a-mount",""),n(this,G).forEach(i=>t.appendChild(i)),n(this,J).forEach(i=>i())})}}G=new WeakMap,J=new WeakMap;const F2=()=>new X2,Z=s=>`<div class="${s}" ></div>`,G2=function(s){s.split(" ").forEach(e=>this.classList.add(e))},J2=function([s,e]){if(s==="class")return G2.call(this,e);this[s]=e},K2=(s,e)=>s+e,G1=(s,e,t)=>{const i=document.createElement(s);return e&&Object.entries(e).forEach(J2,i),i.innerHTML=[t].flat().reduce(K2,""),i},J1=()=>{Object.entries(Y.screens).forEach(([s])=>P1(s)?document.body.classList.add(s):document.body.classList.remove(s))},U2=()=>{J1(),window.addEventListener("resize",J1)},Y2=`<a-surface>
	<section
		id="header"
...
>
	<a-container class="grid grid-cols-12 gap-6">
		<div
			class="about__image about__image-url col-span-12 md:col-span-5"
			a-bg-image="/images/about.png"
		></div>
...
`,st=`<section a-animation="from-bottom">
	<a-container
...
`,at=s=>{var e;(e=document.querySelector(s))==null||e.scrollIntoView({behavior:"smooth",block:"start"})},rt=()=>{$.emit("scroll-to",at)},ot={spin:"animate-spin",bounce:"animate-bounce",pulse:"animate-pulse",ping:"animate-ping","from-left":"animate-from-left","from-right":"animate-from-right","from-bottom":"animate-from-bottom","from-top":"animate-from-top"},lt=()=>{document.querySelectorAll("[a-animation]").forEach(s=>{s.classList.add("invisible");const e={name:A2(s,"a-animation","pulse"),infinity:e2(s,"a-animation-infinity")};new IntersectionObserver((t,i)=>{t[0].isIntersecting&&(s.classList.remove("invisible"),s.classList.add(ot[e.name]),i.unobserve(s))},{threshold:.25}).observe(s)})};F2().use(U2).use(rt).use(lt).template(G1("div",null,x())).template(G1("div",{id:"main",class:"bg-white text-black text-merriweather"},[Y2,K1,Z("h-14 md:h-24"),tt,Z("h-6 md:h-16"),et,Z("h-30 md:h-50"),nt,Z("h-30 md:h-50"),it,Z("h-25 md:h-35"),K1,st])).mount("#app");const dt=()=>{console.log("/four-horses"),document.querySelectorAll("[a-bg-image]")};dt();
